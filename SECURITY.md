...
When policies are tenant-specific, use cache invalidation whenever the tenant's CORS configuration changes. Never enable credentials with a wildcard origin.
